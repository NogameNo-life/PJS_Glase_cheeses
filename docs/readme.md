...
5. Чтобы перейти со стержней на классику требуются мойка системы, переналадка с настройкой ручьев, мойка наполнителя, мойка глазировочника, вске это занимает 4-5 часов.
